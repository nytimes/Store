...
![Simple Store Flow](https://github.com/nytm/Store/blob/develop/Images/store-1.jpg)
...
![Simple Store Flow](https://github.com/nytm/Store/blob/develop/Images/store-2.jpg)
...
`store.get()` -> ![Simple Store Flow](https://github.com/nytm/Store/blob/develop/Images/store-3.jpg)
...
`store.get()` -> ![Simple Store Flow](https://github.com/nytm/Store/blob/develop/Images/store-5.jpg)
