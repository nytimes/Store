...
class StoreRefreshWhenStaleTest {
    ...
    @Mock
    internal var persister: RecordPersister? = null
    @Mock
    internal var network1: BufferedSource? = null
    @Mock
    internal var disk1: BufferedSource? = null
    @Mock
    internal var disk2: BufferedSource? = null

    private val barCode = BarCode("key", "value")
    private var store: Store<BufferedSource, BarCode>? = null
