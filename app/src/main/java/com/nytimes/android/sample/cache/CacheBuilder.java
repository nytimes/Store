...
import com.nytimes.android.sample.cache.AbstractCache.StatsCounter;
...
// --Commented out by Inspection START (11/29/16, 5:01 PM):
//  /**
...
//    return this;
//  }
// --Commented out by Inspection STOP (11/29/16, 5:01 PM)
...
//    Preconditions.checkState(this.initialCapacity == UNSET_INT, "initial capacity was already set to %s",
...
//    Preconditions.checkState(refreshNanos == UNSET_INT, "refresh was already set to %s ns", refreshNanos);
